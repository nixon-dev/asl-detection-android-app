...
import com.nixon.signlanguagedetector.databinding.ActivityCameraDetectionBinding
...
class CameraDetectionActivity : AppCompatActivity(), Detector.DetectorListener {
    ...
    private lateinit var detectedLetterTextView: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        detectedLetterTextView = findViewById(R.id.detectedLetter)

        backButton = findViewById(R.id.mainLayoutBtn)
    ...
    override fun onDetect(boundingBoxes: List<BoundingBox>, inferenceTime: Long) {
        if (boundingBoxes.isNotEmpty()) {
            ...
            runOnUiThread {
                detectedLetterTextView.text = "Detected: $detectedClass"
